...
const translations = {
  ar: {
    ...
    support_badge:'دعم', support_title:'مركز الدعم والمساعدة', support_bot:'دردشة مع البوت', support_bot_desc:'ردود فورية على مدار الساعة', support_tg:'تيليجرام', support_tg_desc:'nimber1 — دعم فوري', support_wa:'واتساب', support_wa_desc:'دعم مباشر 24/7', faq_title:'الأسئلة الشائعة',
  ...
  en: {
    ...
    support_badge:'SUPPORT', support_title:'Support Center', support_bot:'Chat with Bot', support_bot_desc:'Instant replies around the clock', support_tg:'Telegram', support_tg_desc:'nimber1 — instant support', support_wa:'WhatsApp', support_wa_desc:'Direct support 24/7', faq_title:'Frequently Asked Questions',
