  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
      {step === 1 && (<>
        ...
        <div>
          <label style={{ display:'block', fontSize:'0.72rem', color:'var(--text-3)', fontFamily:"'JetBrains Mono',monospace", marginBottom:5 }}>الاسم الثلاثي</label>
          <input value={fullName} onChange={e => setFullName(e.target.value)} placeholder="محمد أحمد علي" style={inp}
        ...
        <div>
          <label style={{ display:'block', fontSize:'0.72rem', color:'var(--text-3)', fontFamily:"'JetBrains Mono',monospace", marginBottom:5 }}>رقم الهاتف</label>
        ...
        <button onClick={handleStep1}
          style={{ width:'100%', padding:11, background:'linear-gradient(135deg,#009fc0,#006e9e)', border:'none', borderRadius:11, fontFamily:"'Tajawal',sans-serif", fontSize:'0.95rem', fontWeight:800, color:'#fff', cursor:'pointer' }}>
          التالي ←
        </button>
      </>)}
      ...
      {step === 2 && (<>
        ...
        <button onClick={handleStep2} disabled={loading}
          style={{ width:'100%', padding:11, background:'linear-gradient(135deg,#009fc0,#006e9e)', border:'none', borderRadius:11, fontFamily:"'Tajawal',sans-serif", fontSize:'0.95rem', fontWeight:800, color:'#fff', cursor: loading ? 'not-allowed' : 'pointer', marginTop:8 }}>
      ...
      {step === 3 && (<>
        ...
        <button onClick={handleStep3} disabled={loading}
          style={{ width:'100%', padding:11, background:'linear-gradient(135deg,#00c97a,#009960)', border:'none', borderRadius:11, fontFamily:"'Tajawal',sans-serif", fontSize:'0.95rem', fontWeight:800, color:'#fff', cursor: loading ? 'not-allowed' : 'pointer' }}>
      ...
      <div style={{ textAlign:'center', fontSize:'0.82rem', color:'var(--text-3)' }}>
        لديك حساب؟{' '}
        <button onClick={onSwitch} style={{ background:'none', border:'none', color:'var(--cyan)', fontFamily:"'Tajawal',sans-serif", fontSize:'0.82rem', fontWeight:700, cursor:'pointer' }}>
          تسجيل الدخول
        </button>
      </div>
    </div>
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
      ...
      <button onClick={handle} disabled={loading}
        style={{ width:'100%', padding:11, background:'linear-gradient(135deg,#009fc0,#006e9e)', border:'none', borderRadius:11, fontFamily:"'Tajawal',sans-serif", fontSize:'0.95rem', fontWeight:800, color:'#fff', cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1 }}>
